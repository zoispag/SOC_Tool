						...
						<div class="col-lg-6 text-center" style="margin-top:30px;">
							...
							<table style="font-size:18px; color:#2f4f4f; font-family: Verdana;" class="table">
								<tr style="font-weight:bold; border-top:solid 2px; border-left:solid 2px; border-right:solid 2px;">
									<td></td>
									<th style="text-align:center">Backlog</td>
									<th style="min-width:90px; text-align:center">L1->L2</td>
...
-->    
        ...
        <!-- /#page-wrapper -->
<!--        <div id="timeContainer" style="visibility:hidden;"><?php echo $report; ?></div>--> 
    </div>
    <!-- /#wrapper -->
...
<script>
	$(document).ready(function() {
		...
		$("#setRecords15").click(function(){
            ...
            $("#container").load("./functions/report_mails/epopteia_mail.php?isi="+<?php echo $Gkez2; ?>+"&isp="+<?php echo $Gkez3; ?>+"&isb="+<?php echo $Gkez4; ?>+"&voi="+<?php echo $voi; ?>+"&vop="+<?php echo $vop; ?>+"&vob="+<?php echo $vob; ?>+"&tei="+<?php echo $tei; ?>+"&tep="+<?php echo $tep; ?>+"&teb="+<?php echo $teb; ?>+"&wsi="+<?php echo $wsi; ?>+"&tvi="+<?php echo $tvi; ?>);
