...
<?php
    ...
    //IPTV
    $tvb = fetchIPTVBacklog(httpGet($BradinoStatistics));
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body text-center">
							...
							<table class="table table-bordered table-striped" style="font-size:11px; color:#2f4f4f; font-family: Verdana; text-align:center; vertical-align:middle;">
								...
								<tr style="border-top:solid 2px; border-left:solid 2px; border-right:solid 2px;">
									...
									<td><?php echo $isb; ?></td>
									<td><?php echo $isi; ?></td>
									<td class="small" rowspan="3" style="vertical-align:middle;"><b>Back:</b> <?php echo $socInternetBack; ?><br><b>In:</b> <?php echo $socInternetIn; ?></td>
								</tr>
								...
								<tr style="border-top:solid 2px; border-left:solid 2px; border-right:solid 2px;">
									...
									<td><?php echo $vob; ?></td>
									<td><?php echo $voi; ?></td>
									<td class="small" style="border-bottom:solid 2px; vertical-align:middle;" rowspan="2"><b>Back:</b> <?php echo $socTeleBack; ?><br><b>In:</b> <?php echo $socTeleIn; ?></td>
								</tr>
                            ...
                            <a href="#" class="btn btn-default btn-block">Refresh</a>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
