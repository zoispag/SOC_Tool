<div id="script_1" style="visibility:hidden">
    <script>
        ...
        $("#modal_force_open_1").click(function(){
            var _comment = encodeURI($("#txt_comment").val());
            var _date = encodeURI($("#txt_created").val());
            
            $("#container_modal").load("./functions/mailer/is/type_1_preview.php?txt_comment="+_comment+"&txt_created="+_date, {txt_sr: $("#txt_sr").val(), txt_dslam: $("#txt_dslam").val(), txt_ems: $("#txt_ems").val(), type_fault: $("#type_fault").val(), type_receivers: $("#type_receivers").val(), txt_more_than_one: $("#txt_more_than_one").is(':checked') ?1 : 0 });
       ...
       $("#send_mail").click(function(){
            ...
            $("#container").load("./functions/mailer/is/type_1_send.php?txt_comment="+_comment+"&txt_created="+_date, {txt_sr: $("#txt_sr").val(), txt_dslam: $("#txt_dslam").val(), txt_ems: $("#txt_ems").val(), type_fault: $("#type_fault").val(), type_receivers: $("#type_receivers").val(), txt_more_than_one: $("#txt_more_than_one").is(':checked') ?1 : 0 });
            $("#container-sql").load("./functions/mailer/is/type_1_db.php", {txt_sr: $("#txt_sr").val(), txt_element: $("#txt_ems").val()});
        }); 
    </script>
</div>