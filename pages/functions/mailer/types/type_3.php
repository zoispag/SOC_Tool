<div id="type_3" style="visibility:hidden">
    <table class="table">
        <tr>
            <td>
            ...
            <td>
                <select class="type_3_mail" require="true" name="type_receivers" id="type_receivers">
        ...
        <tr>
            ...
            <td>
                <select class="type_3_mail" style="width:250px" require="true" name="type_fault" id="type_fault">
                    <option disabled selected>--------------------</option>
        ...
        <tr>
            ...
            <td>
                <input class="type_3_mail" id="txt_more_than_one" type="checkbox" value="1" checked> Περισσότερες από 1
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input class="type_3_mail req_field" style="width:250px" type="text" name="txt_dslam" id="txt_dslam" maxlength="5"> <img src="./images/validate.png" alt="validate" width="18" id="validate_dslam">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input disabled class="type_3_mail" style="width:250px; font-size:10px;" type="text" name="txt_ems" id="txt_ems" maxlength="100">
            </td>
        </tr>
        <tr>
            <td>
                <label for="txt_ems">DSLAM Slot</label>
            </td>
            <td>
                <input class="type_3_mail" style="width:250px;" type="text" name="txt_slot" id="txt_slot" maxlength="3">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input style="width:250px" class="type_3_mail" placeholder="1-1xxxxxxxxxx" type="text" name="txt_sr" id="txt_sr" >
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input class="type_3_mail" style="width:250px;" type="text" name="txt_created" id="txt_created" maxlength="100">
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <button type="button" id="modal_force_open_3" class="btn btn-s btn-outline btn-danger" data-toggle="modal" data-target="#myModal_3">
